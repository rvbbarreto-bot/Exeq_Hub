...
def hub_nav_flags(request):
    out = {
        "nfse_enabled_nav": False,
        "nfe_enabled_nav": False,
        "nfce_enabled_nav": False,
        "nfe_entrada_enabled_nav": False,
        "nfe_product_enabled": nfe_global_enabled(),
        "nfce_product_enabled": nfce_global_enabled(),
    ...
    if tenant is None:
        out["sidebar_navigation"] = []
        return out
    out["nfse_enabled_nav"] = nfse_enabled_for_tenant(tenant)
    out["nfe_enabled_nav"] = nfe_enabled_for_tenant(tenant)
    out["nfce_enabled_nav"] = nfce_enabled_for_tenant(tenant)
    out["nfe_entrada_enabled_nav"] = nfe_entrada_enabled_for_tenant(tenant)
    ...
    out["sidebar_navigation"] = build_sidebar_navigation(request=request, flags=out)
    return out
