"""Grupo UB (IBSCBS) NFC-e mod 65 — RTC emit."""
...
from apps.nfce.rtc import RTC_DEFAULT_CLASS, RTC_DEFAULT_CST, rtc_money_fields
...
def append_total_ibscbs(total_el: ET.Element, rtc_totals: dict[str, Any], *, v_nf_cents: int) -> None:
    ...
    v_nftot = int(rtc_totals.get("v_nftot_cents") or (v_nf_cents + int(rtc_totals.get("v_ibs_cents") or 0) + int(rtc_totals.get("v_cbs_cents") or 0)))
